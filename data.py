...
# --- SessionMember ---
# Used to track when members join/leave a session
    ...
    def add_session_member(self, session_id: int, member_id: int, start: datetime.datetime, end: datetime.datetime):
    ...
    def add_or_update_session_member(self, session_id: int, member_id: int, start: Optional[datetime.datetime] = None, end: Optional[datetime.datetime] = None):
        ...
        if session_member is None:
            self.add_session_member(session_id, member_id, start=start, end=end)
        else:
...
# -- SessionMemberGame --
# Use to track when a member starts playing/finishes playing a game within a session
